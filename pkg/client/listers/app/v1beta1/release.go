...
type ReleaseLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Release, err error)
...
// List lists all Releases in the indexer.
func (s *releaseLister) List(selector labels.Selector) (ret []*v1beta1.Release, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Release))
	})
	return ret, err
}
...
type ReleaseNamespaceLister interface {
	...
	Get(name string) (*v1beta1.Release, error)
...
// List lists all Releases in the indexer for a given namespace.
func (s releaseNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Release, err error) {
...
// Get retrieves the Release from the indexer for a given namespace and name.
func (s releaseNamespaceLister) Get(name string) (*v1beta1.Release, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("release"), name)
	}
	return obj.(*v1beta1.Release), nil
}
