...
type ChartLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Chart, err error)
...
// List lists all Charts in the indexer.
func (s *chartLister) List(selector labels.Selector) (ret []*v1beta1.Chart, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Chart))
	})
	return ret, err
}
...
type ChartNamespaceLister interface {
	...
	Get(name string) (*v1beta1.Chart, error)
...
// List lists all Charts in the indexer for a given namespace.
func (s chartNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Chart, err error) {
...
// Get retrieves the Chart from the indexer for a given namespace and name.
func (s chartNamespaceLister) Get(name string) (*v1beta1.Chart, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("chart"), name)
	}
	return obj.(*v1beta1.Chart), nil
}
