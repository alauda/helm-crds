...
type HelmRequestInterface interface {
	Create(*appv1.HelmRequest) (*appv1.HelmRequest, error)
	Update(*appv1.HelmRequest) (*appv1.HelmRequest, error)
	UpdateStatus(*appv1.HelmRequest) (*appv1.HelmRequest, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*appv1.HelmRequest, error)
	List(opts v1.ListOptions) (*appv1.HelmRequestList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.HelmRequest, err error)
...
func newHelmRequests(c *AppV1Client, namespace string) *helmRequests {
	return &helmRequests{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *helmRequests) Get(name string, options v1.GetOptions) (result *appv1.HelmRequest, err error) {
	result = &appv1.HelmRequest{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *helmRequests) List(opts v1.ListOptions) (result *appv1.HelmRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &appv1.HelmRequestList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("helmrequests").
...
func (c *helmRequests) Create(helmRequest *appv1.HelmRequest) (result *appv1.HelmRequest, err error) {
	result = &appv1.HelmRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("helmrequests").
...
func (c *helmRequests) Update(helmRequest *appv1.HelmRequest) (result *appv1.HelmRequest, err error) {
	result = &appv1.HelmRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("helmrequests").
...
func (c *helmRequests) UpdateStatus(helmRequest *appv1.HelmRequest) (result *appv1.HelmRequest, err error) {
	result = &appv1.HelmRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("helmrequests").
...
func (c *helmRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.HelmRequest, err error) {
	result = &appv1.HelmRequest{}
