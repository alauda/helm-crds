...
type ChartRepoInterface interface {
	Create(*appv1.ChartRepo) (*appv1.ChartRepo, error)
	Update(*appv1.ChartRepo) (*appv1.ChartRepo, error)
	UpdateStatus(*appv1.ChartRepo) (*appv1.ChartRepo, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*appv1.ChartRepo, error)
	List(opts v1.ListOptions) (*appv1.ChartRepoList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.ChartRepo, err error)
	ChartRepoExpansion
}
...
func newChartRepos(c *AppV1Client, namespace string) *chartRepos {
	return &chartRepos{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *chartRepos) Get(name string, options v1.GetOptions) (result *appv1.ChartRepo, err error) {
	result = &appv1.ChartRepo{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("chartrepos").
		Name(name).
...
func (c *chartRepos) List(opts v1.ListOptions) (result *appv1.ChartRepoList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &appv1.ChartRepoList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("chartrepos").
...
func (c *chartRepos) Create(chartRepo *appv1.ChartRepo) (result *appv1.ChartRepo, err error) {
	result = &appv1.ChartRepo{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("chartrepos").
...
func (c *chartRepos) Update(chartRepo *appv1.ChartRepo) (result *appv1.ChartRepo, err error) {
	result = &appv1.ChartRepo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("chartrepos").
...
func (c *chartRepos) UpdateStatus(chartRepo *appv1.ChartRepo) (result *appv1.ChartRepo, err error) {
	result = &appv1.ChartRepo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("chartrepos").
...
func (c *chartRepos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.ChartRepo, err error) {
	result = &appv1.ChartRepo{}
