...
type ChartInterface interface {
	Create(*appv1.Chart) (*appv1.Chart, error)
	Update(*appv1.Chart) (*appv1.Chart, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*appv1.Chart, error)
	List(opts v1.ListOptions) (*appv1.ChartList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.Chart, err error)
	ChartExpansion
}
...
func newCharts(c *AppV1Client, namespace string) *charts {
	return &charts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *charts) Get(name string, options v1.GetOptions) (result *appv1.Chart, err error) {
	result = &appv1.Chart{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) List(opts v1.ListOptions) (result *appv1.ChartList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &appv1.ChartList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) Create(chart *appv1.Chart) (result *appv1.Chart, err error) {
	result = &appv1.Chart{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) Update(chart *appv1.Chart) (result *appv1.Chart, err error) {
	result = &appv1.Chart{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("charts").
...
func (c *charts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.Chart, err error) {
	result = &appv1.Chart{}
