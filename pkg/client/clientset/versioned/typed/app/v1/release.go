...
type ReleaseInterface interface {
	Create(*appv1.Release) (*appv1.Release, error)
	Update(*appv1.Release) (*appv1.Release, error)
	UpdateStatus(*appv1.Release) (*appv1.Release, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*appv1.Release, error)
	List(opts v1.ListOptions) (*appv1.ReleaseList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.Release, err error)
	ReleaseExpansion
}
...
func newReleases(c *AppV1Client, namespace string) *releases {
	return &releases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *releases) Get(name string, options v1.GetOptions) (result *appv1.Release, err error) {
	result = &appv1.Release{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
		Name(name).
...
func (c *releases) List(opts v1.ListOptions) (result *appv1.ReleaseList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &appv1.ReleaseList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Create(release *appv1.Release) (result *appv1.Release, err error) {
	result = &appv1.Release{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Update(release *appv1.Release) (result *appv1.Release, err error) {
	result = &appv1.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) UpdateStatus(release *appv1.Release) (result *appv1.Release, err error) {
	result = &appv1.Release{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("releases").
...
func (c *releases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *appv1.Release, err error) {
	result = &appv1.Release{}
