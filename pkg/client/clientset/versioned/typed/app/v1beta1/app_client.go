...
// AppV1beta1Client is used to interact with features provided by the app.alauda.io group.
type AppV1beta1Client struct {
	restClient rest.Interface
}

func (c *AppV1beta1Client) Charts(namespace string) ChartInterface {
	return newCharts(c, namespace)
}

func (c *AppV1beta1Client) ChartRepos(namespace string) ChartRepoInterface {
	return newChartRepos(c, namespace)
}

func (c *AppV1beta1Client) HelmRequests(namespace string) HelmRequestInterface {
	return newHelmRequests(c, namespace)
}

func (c *AppV1beta1Client) Releases(namespace string) ReleaseInterface {
