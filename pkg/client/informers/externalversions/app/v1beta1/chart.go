	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1beta1().Charts(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1beta1().Charts(namespace).Watch(options)
			},
		},
		&appv1beta1.Chart{},
		resyncPeriod,
...
func (f *chartInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appv1beta1.Chart{}, f.defaultInformer)
}

func (f *chartInformer) Lister() v1beta1.ChartLister {
	return v1beta1.NewChartLister(f.Informer().GetIndexer())
}
