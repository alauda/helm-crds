...
import (
	...
	v1beta1 "github.com/alauda/helm-crds/pkg/client/listers/app/v1beta1"
...
type HelmRequestInformer interface {
	...
	Lister() v1beta1.HelmRequestLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppV1beta1().HelmRequests(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppV1beta1().HelmRequests(namespace).Watch(options)
			},
		},
		&appv1beta1.HelmRequest{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *helmRequestInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appv1beta1.HelmRequest{}, f.defaultInformer)
}

func (f *helmRequestInformer) Lister() v1beta1.HelmRequestLister {
	return v1beta1.NewHelmRequestLister(f.Informer().GetIndexer())
}
